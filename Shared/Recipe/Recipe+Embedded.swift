...
extension Array where Element == Recipe {
    static let embedded: Self = [
        ...
        Recipe(id: UUID(uuidString: "AEBD134B-443E-494F-BD1C-B85E221617A2") ?? UUID(), name: "Bread and cheese", mealCount: 1, ingredients: [
            Ingredient(id: UUID(uuidString: "B5F6F05E-4B82-46CB-80A9-1EB0A0202039") ?? UUID(), name: "Bread", quantity: 400, unit: UnitMass.grams),
            Ingredient(id: UUID(uuidString: "44C25072-9BC8-4E28-A74D-8E19CE6D64FE") ?? UUID(), name: "Cheese", quantity: 200, unit: UnitMass.grams),
        ]),
        Recipe(id: UUID(uuidString: "05B34E8C-10F1-4E96-BCA6-E74559509D17") ?? UUID(), name: "Meatballs with Rice and Courgettes", mealCount: 2, ingredients: [
            Ingredient(id: UUID(uuidString: "07A649E1-8A81-408F-A7BA-0DF4A9A63371") ?? UUID(), name: "Meatball", quantity: 8),
            Ingredient(id: UUID(uuidString: "B5AD115B-A233-4636-AC37-EAEE20BF43FD") ?? UUID(), name: "Rice", quantity: 300, unit: UnitMass.grams),
            Ingredient(id: UUID(uuidString: "63F5B07E-505C-40E8-8225-9C98B9A23BFA") ?? UUID(), name: "Courgettes", quantity: 200, unit: UnitMass.grams),
        ]),
        Recipe(id: UUID(uuidString: "00E7C592-1F7B-4501-926C-C1F7E4E62609") ?? UUID(), name: "Olivade", mealCount: 2, ingredients: [
            Ingredient(id: UUID(uuidString: "266916A5-977A-4590-978F-D5AA1195DC51") ?? UUID(), name: "Olive", quantity: 150, unit: UnitMass.grams),
            Ingredient(id: UUID(uuidString: "08EF8945-1E87-4337-B985-12E851A3A3AA") ?? UUID(), name: "Garlic clove", quantity: 1),
            Ingredient(id: UUID(uuidString: "7EB07C98-41D6-4035-92E8-5DE79F483A4B") ?? UUID(), name: "Lemon juice", quantity: 1, unit: UnitVolume.teaspoons),
            Ingredient(id: UUID(uuidString: "294D0B98-7127-4AE0-ADF5-2921537493F9") ?? UUID(), name: "Olive oild", quantity: 2, unit: UnitVolume.tablespoons),
            Ingredient(id: UUID(uuidString: "FACA71DB-BC64-4979-A277-09F42ECDC2EC") ?? UUID(), name: "Pepper", quantity: 1),
        ]),
    ]
}
